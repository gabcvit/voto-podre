  ...
  <div class="max-w-3xl mx-auto px-4 py-12">
    ...
    <section class="mb-10 border-b border-zinc-200 pb-10 dark:border-zinc-800">
      ...
      <p class="text-zinc-500 leading-relaxed text-sm">
        ...
        vida do povo brasileiro e, muitas vezes, retrocedem conquistas históricas.
      </p>
    </section>
    ...
    <section class="mb-10 border-b border-zinc-200 pb-10 dark:border-zinc-800">
      ...
      <ol class="space-y-3 text-sm">
        <li class="flex items-start gap-3">
          ...
          <span class="text-zinc-500">Consulte a lista de <RouterLink to="/pautas-podres" class="text-zinc-900 font-bold hover:text-red-500 transition-colors dark:text-white">Pautas Podres</RouterLink> para entender cada votação problemática.</span>
        </li>
        <li class="flex items-start gap-3">
          <span class="text-xs font-black text-red-500 w-5 flex-shrink-0 pt-0.5">02</span>
          <span class="text-zinc-500">Veja quais <RouterLink to="/deputados" class="text-zinc-900 font-bold hover:text-red-500 transition-colors dark:text-white">Deputados</RouterLink> apoiaram essas pautas.</span>
        </li>
        <li class="flex items-start gap-3">
